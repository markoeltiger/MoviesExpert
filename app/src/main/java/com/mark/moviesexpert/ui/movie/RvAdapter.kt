...
class RvAdapter(
    ...
    inner class ViewHolder(val binding: com.mark.moviesexpert.databinding.ViewHolderGenreBinding) :
        RecyclerView.ViewHolder(binding.root)


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = com.mark.moviesexpert.databinding.ViewHolderGenreBinding.inflate(
